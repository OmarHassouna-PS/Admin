...
export default function AddModal({handleModal, setIsAdd, isAdd }) {
    return (
        <>
            {/* Add User Modal */}
            <div
                className={`fixed left-0 top-0 md:left-[300px] md:top-37 right-0 z-50 mt-10 items-center justify-center py-20 sm:p-10 ${isAdd ? 'flex' : 'hidden '} overflow-x-hidden overflow-y-auto  h-modal`}
                id="add-user-modal"
            >
                <div className="relative w-full h-full max-w-2xl px-4 md:h-auto">
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
                        ...
                        <div className="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                            ...
                            <button onClick={() => handleModal(setIsAdd, false)}
                                type="button"
